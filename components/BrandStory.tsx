...
export default function BrandStory() {
  return (
    <section id="tentang" className="relative overflow-hidden bg-jalar-dark py-20 md:py-28">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-6 px-5 sm:px-8 lg:grid-cols-[1.15fr_1.3fr_0.95fr] lg:gap-4">
        {/* Karakter kiri (diperbesar) */}
        <Reveal className="order-1 flex justify-center lg:order-none lg:justify-start">
          <Image
            src="/images/about-left.png"
            alt="Maskot JALAR"
            width={285}
            height={337}
            className="h-auto w-[64%] max-w-[320px] drop-shadow-[0_12px_40px_rgba(220,38,38,0.4)] sm:max-w-[380px] lg:w-full lg:max-w-[480px]"
          />
        </Reveal>
        ...
        {/* Karakter kanan */}
        <Reveal delay={0.1} className="order-3 flex justify-center lg:order-none lg:justify-end">
          <Image
            src="/images/about-right.png"
            alt="Maskot JALAR"
            width={286}
            height={337}
            className="h-auto w-[56%] max-w-[270px] drop-shadow-[0_12px_40px_rgba(249,115,22,0.4)] sm:max-w-[320px] lg:w-full lg:max-w-[380px]"
          />
        </Reveal>
      </div>
    </section>
